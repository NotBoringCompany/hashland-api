...
export class DrillingCycleGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    handleTestEvent(client: Socket, payload: any): void {
        this.logger.log(`Received test event from client ${client.id}: ${JSON.stringify(payload)}`);
