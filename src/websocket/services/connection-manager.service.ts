...
export class ConnectionManagerService {
    ...
    registerUserConnection(
        ...
        try {
            ...
            if (drillingSessionId) {
                ...
                this.logger.log(`User ${userId} started drilling session ${drillingSessionId} with socket ${socket.id}`);
            }
    ...
    isUserDrilling(userId: string): boolean {
        ...
        return this.userConnections.get(userIdStr).some(conn => !!conn.drillingSessionId);
    }
