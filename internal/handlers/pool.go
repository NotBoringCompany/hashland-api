...
func CreatePoolAdminHandler(c *fiber.Ctx) error {
	type RequestBody struct {
		...
		JoinPrerequisites string `json:"join_prerequisites"` // JSON string
	}
	...
	poolID, err := services.CreatePoolAdminService(body.AdminPassword, body.LeaderID, body.MaxOperators, body.RewardSystem, body.JoinPrerequisites)
	if err != nil {
